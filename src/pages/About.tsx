import { CheckCircle, Target, Eye, BookOpen } from "lucide-react";
...
const About = () => (
  <>
    ...
    <section className="py-16 bg-section-gradient">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-heading text-3xl font-bold mb-6">Founder's Message</h2>
    ...
    <section className="py-16 bg-hero-gradient">
      <div className="container">
        <h2 className="font-heading text-3xl font-bold text-primary-foreground text-center mb-12">Why Choose Pal Classes?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "10+ Years of Excellence", desc: "A proven track record of producing toppers and successful students." },
